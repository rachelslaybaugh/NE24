...
class NumJellyEstimator:
    ...
    ## Set the world population
    # \param number of people in the world(integer)
    def set_world_pop(self, people):
    ...
    ## Estimate the number of jelly beans in the world given the world's population, fraction of land used for suger, and a scaling constant. Prints error if returns 0.
