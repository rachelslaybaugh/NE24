...
% Course title header
\begin{center}
{\bf NE 24 - Putting the Science in Computational Science \\ M 3:00 - 4:00 pm in 102 Latimer
}
\end{center}
...
\vskip.25in
\noindent\textbf{Office Hours:} 2:00 - 3:00 PM F and by appointment
...
\noindent This course will equip you to begin a career in science or engineering in which you can tackle computational science projects effectively. You will learn
\begin{itemize}
\item how to create, use, and share structured data;
\item how to automate repetitive tasks; 
\item how to track and share work over the web; and
\item how to grow a program in a modular, testable, reusable way.
\end{itemize}
...
\begin{itemize}
  \item We'll use some of Software Carpentry's lessons: \href{http://software-carpentry.org/lessons.html}{http://software-carpentry.org/lessons.html}
  %\item Course notes + handouts: \href{https://github.com/rachelslaybaugh/NE24}{https://github.com/rachelslaybaugh/NE24}
  \item bCourses site: \href{https://bcourses.berkeley.edu/courses/1292803}{https://bcourses.berkeley.edu/courses/1292803} 
...
\item building programs with Python; iPython
...
4 & 23-Feb & Git local \\ \hline
5 & 2-Mar & Git remote \\ \hline
6 & 9-Mar & Git remote \\ \hline
7 & 16-Mar & Python \\ \hline
- & 23-Mar & \textit{spring break} \\ \hline
8 & 30-Mar & iPython \\ \hline
9 & 6-Apr & Python \\ \hline
10 & 13-Apr & testing \\ \hline
11 & 20-Apr & testing \\ \hline
